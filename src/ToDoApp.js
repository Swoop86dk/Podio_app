var ToDoApp = window.ToDoApp = (function() {
  ...
  var _templates = {
    ...
    body:
      ...
      <div id="left-col">\
        <div id="lists"></div>\
        <input type="text" id="create-list-name-input" placeholder="Create list" />\
      </div>\
      <div id="right-col">\
        <div id="tasks"></div>\
        <div>\
    ...
    list: '<a href="<%= href %>">Kontrakt #: <%= id %> <br></br> Genstand: <%= name %> <br><br/> Kunde: <%= customer %> <br><br/> Dato for udbetaling: <%= payDate %> <br/> Rente pr. måned: <%= interest %> <br/> Udbetaling: <%= payout %> </a>  <br><br/>',
  };
  ...
  ToDoApp.prototype.loadContacts = function() {
    var self = this;
    console.log("kører funktion");
